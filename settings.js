...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=33QFmaoD#TZLs94VCJ73QLLiO20pYMnF1zGQykK0KKYuuovJTTVI' : process.env.SESSION_ID,
...
DELETEMSGSENDTO : process.env.DELETEMSGSENDTO === undefined ? '+94767024825' : process.env.DELETEMSGSENDTO,
...
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "danupaacedemy@gmail.com" : process.env.SEEDER_GMAIL,
SEEDER_PASSWORD: process.env.SEEDER_PASSWORD === undefined ? "x1ah25m30" : process.env.SEEDER_PASSWORD,
